		...
		<div id="container">
			<div id="content">
				...
				<form name="signUpForm" id="form">
					...
					<table>
						<tbody>
							...
							<tr>
								<th>비밀번호</th>
								<td><input type="password" name="password" value="${login.password}"
							...
							<tr>
								<th>비밀번호 확인</th>
								<td><input type="password" name="password2" value="${login.password}"
              				...
              				<tr>
								<th>휴대폰 번호</th>
								<td>
									<input id="dev_hphone1" name="Phone1" class="tBox joinBx tPhone" type="text" title="휴대폰 번호" value="${fn:substring(login.phone, 0, 3)}" size="3" maxlength="3"
									autocomplete="off"> - 
              ...
              <tr>
                <th>사업주</th>
                <td>
                  <input type="text" class="tBox comNum" name="name" id="comNum" size="10" maxlength="20" value="${login.name}">
                </td>
              </tr>
              ...
              <tr>
                <th>사업자등록번호</th>
                <td>
                  <input type="text" class="tBox comNum" name="b_number" id="comNum" size="10" maxlength="10" value="${login.b_number}">
                </td>
              </tr>
              ...
              <tr>
              	<th>사업체명</th>
              	<td>
              		<input type="text" class="tBox comName" name="work_place_name" id="comName" size="25" maxlength="25" value="${login.work_place_name}">
              ...
              <tr>
              	...
              	<td>
	              	<div class="jobcho-line1">
	              		<div class="jobchoice">${login.job_type}</div>
              ...
              <tr>
              	<th>사업장소개</th>
              	<td>
              		<textarea form="form" name="introduction">${login.introduction}</textarea>
              	</td>
              </tr>
              <tr>
              <th>주소</th>
              ...
              <div class="search" style="margin-left:20%;"></div>
					...
					<br>
					<input type="text" id="sample6_address" class="sample6_address" placeholder="주소" name="address" value="${login.address}"/>
