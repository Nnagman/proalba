...
개인정보처리방침(버전 3.0.0)
주식회사 프로알바(이하, "회사"라 함)은 프로알바(이하, “서비스”라 함)을 운영하며 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법, 통신비밀보호법, 전기통신사업법 등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보처리방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.
...
- 필수항목 : 이메일, 이름(닉네임), 비밀번호, 유형(개인/기업/단체), 지역
- 선택항목 : 프로필 사진, 회사/단체 이름, 회사/단체 규모, 산업군, 부서
...
콘텐츠 제공, 특정 맞춤 서비스 제공, 유료서비스 이용에 대한 과금, 구매 및 요금 결제, 본인인증, 물품배송 또는 청구서 등 발송, 요금 추심 등
4) 법적 증거로 활용
법적 분쟁시 증거자료 제출
...
2) NHN 한국사이버결제 : 휴대폰 본인 확인
3) 엔에이치엔엔터테인먼트(주) : 카카오 알림톡 발송
4) Amazon Web Services Inc. : 개인정보가 저장된 국내외 클라우드 서버 운영 및 관리
...
이용자가 서명 요청자로서 서명 참여자에게 전자서명을 요청할 경우 전자서명 개인정보처리방침이 함께 적용됩니다.</textarea>
</div>
<div class="footer">
