              ...
              커뮤니티
					...
					<div class="nav-itemsub">
						<ul>
							...
							<li><a class="nav-link"
								href="cserFullWorkmanagetable?id=${login.id}"> 일별 근태 관리 </a></li>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header card-header-primary pser-header">
									...
									<p class="card-category">${name}님의급여현황입니다.</p>
								</div>
								<div class="card-body">
											...
											<tbody>
												<c:forEach var="salary" items="${salarys}"
													...
													<tr>
														...
														<td><input type="hidden" value="${status.index}" />
						...
						if (salary.sa_code == sa_code) {
																$(
																		...
																		.text(
																				salary.basic_salary);
																$(
																		"#national_pension_cost")
																		.text(
																				salary.national_pension_cost);
																$(
																		"#food_expenses")
																		.text(
																				salary.food_expenses);
																$(
																		"#health_insurance_cost")
																		.text(
																				salary.health_insurance_cost);
																$(
																		"#transportation_fee")
																		.text(
																				salary.transportation_fee);
																$(
																		"#employment_insurance_cost")
																		.text(
																				salary.employment_insurance_cost);
																$(
																		"#additional_extended")
																		.text(
																				salary.additional_extended);
																$(
																		"#additional_night")
																		.text(
																				salary.additional_night);
																$(
																		"#total_salary")
																		.text(
																				parseInt(salary.basic_salary)
																						+ parseInt(salary.food_expenses)
																						+ parseInt(salary.transportation_fee)
																						+ parseInt(salary.additional_extended)
																						+ parseInt(salary.additional_night));
																$(
