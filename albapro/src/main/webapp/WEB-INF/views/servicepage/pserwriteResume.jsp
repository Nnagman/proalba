 ...
 function plasearch() {
	...
	function addLicense(idx) {
		...
		if (limitcnt + certlimitcnt >= 10 && idx == 0) {
			...
			strLicense = strLicense + "			<input type='button' value='수정' class='btn whiteBtn' onclick='modLicense(" + objidx + ");return false;'></a>";
			strLicense = strLicense + "			<input type='button' value='삭제' class='btn whiteBtn' onclick='delLicense(" + objidx + ");return false;'></a>";
			strLicense = strLicense + "		</div>";
