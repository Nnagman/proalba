...
<!-- 수정할곳 -->
									...
									<div class="card-header card-header-primary">
										<h4 class="card-title ">나의 급여내역</h4>
										<p class="card-category">나의 급여내역을 조회하여 한 눈에 확인할 수 있도록 제공되는 메뉴입니다.</p>
									</div>
									...
									<table id="example" class="table">
										  ...
										  <th scope="col" colspan="2" bgcolor="444b52">기타</th>
											...
											<c:forEach var="salary" items="${salarys}">
												...
												<td scope="col" style="width: 80px !important;">${salary.work_place }</td>
