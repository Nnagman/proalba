...
<li class="nav-item">
		...
		<!-- 컨테이너 시작 -->
		<div class="content">
		<div class="pser-header"><%@ include file="../cservicepage/cserNavHeader.jsp"%>
			</div>
		<div class="pser-con">
		...
		<form action="${path}/cserWcontract" method="post">
					...
					<div class="col-md-12"> 
						<h2>전자근로계약서 작성 </h2>
          				<div class="addjob-1">
							...
							기타 급여(재수당 등): <input class="ra" id="y" name="additional_wage" type="radio" value="1" /><span>있음 </span>
			...
			<div class="col-md-12">
           		<div class="addjob-2">
           			사업체명: <input type="text"  name="work_place_name" value="${list[0].work_place_name}" readonly/>
           			<br><br>
           			
           			사업자번호: ${login.b_number}
