...
@Controller
public class PservicepageController {

	@Autowired
	MobileAttendanceService mobileAttendanceService;
	private static final Logger logger = LoggerFactory.getLogger(PservicepageController.class);
	
	@RequestMapping(value = "/pservicepage", method = RequestMethod.GET)
	public ModelAndView pservicepageGET(Model model,@RequestParam("id") String id) throws Exception {
		...
		mav.setViewName("servicepage/pservicepage"); // 酉곕�� list.jsp濡� �ㅼ��
